...
from dataloader import test_loader_2
...
# RESULTS_PATH = Path("checkpoints/test_results_third_dataset.json")

# --- SE ----
CHECKPOINT_PATH = Path("checkpoints/se_best_model.pth")
RESULTS_PATH = Path("checkpoints/se_test_results_third_dataset.json")
